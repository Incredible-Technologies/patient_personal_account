...
export class MedicalCardComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.resultCardService.getAllUserCards()
  .subscribe(cards => {
  ...
  createResultCard(): void {
    if (this.createResultCardForm.valid) {
      this.resultCardService.createResultCard(this.createResultCardForm.value).subscribe({
        next: (resultCard) => {
  ...
  loadAllDoneUserCards() {
    this.resultCardService.getAllDoneUserCards()
      .subscribe(cards => this.doneResultCards = cards);
  }

  loadAllNotDoneUserCards() {
    this.resultCardService.getAllNotDoneUserCards()
